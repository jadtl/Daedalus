...
DDLS_API void* _darray_create(u64 length, u64 stride);
DDLS_API void _darray_destroy(void* array);

DDLS_API u64 _darray_field_get(void* array, u64 field);
DDLS_API void _darray_field_set(void* array, u64 field, u64 value);

DDLS_API void* _darray_resize(void* array);

DDLS_API void* _darray_push(void* array, const void* value_ptr);
DDLS_API void _darray_pop(void* array, void* dest);

DDLS_API void* _darray_pop_at(void* array, u64 index, void* dest);
DDLS_API void* _darray_insert_at(void* array, u64 index, void* value_ptr);

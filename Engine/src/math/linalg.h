...
#define DDLS_HALF_PI 0.5f * DDLS_PI
#define DDLS_QUARTER_PI 0.25f * DDLS_PI
#define DDLS_ONE_OVER_PI 1.0f / DDLS_PI
#define DDLS_ONE_OVER_TWO_PI 1.0f / DDLS_PI_2
#define DDLS_SQRT_TWO 1.41421356237309504880f
#define DDLS_SQRT_THREE 1.73205080756887729352f
#define DDLS_SQRT_ONE_OVER_TWO 0.70710678118654752440f
...
#define DDLS_FLOAT_EPSILON 1.192092896e-07f

namespace ddls {
    // ------------------------------------------
    // General math functions
    // ------------------------------------------
    DDLS_API f32 sin(f32 x);
    DDLS_API f32 cos(f32 x);
    DDLS_API f32 tan(f32 x);
    DDLS_API f32 acos(f32 x);
    DDLS_API f32 sqrt(f32 x);
    DDLS_API f32 abs(f32 x);
     ...
     */
    DDLS_INLINE b8 is_power_of_2(u64 value)
    {
        return (value != 0) && ((value & (value - 1)) == 0);
    }

    DDLS_API i32 random();
    DDLS_API i32 random_in_range(i32 min, i32 max);

    DDLS_API f32 frandom();
    DDLS_API f32 frandom_in_range(f32 min, f32 max);
     ...
     */
    DDLS_INLINE vec2 vec2_create(f32 x, f32 y)
    {
        vec2 out_vector;
        out_vector.x = x;
        out_vector.y = y;
     ...
     */
    DDLS_INLINE vec2 vec2_add(vec2 vector_0, vec2 vector_1)
    {
        return (vec2) {
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec2 vec2_sub(vec2 vector_0, vec2 vector_1)
    {
        return (vec2) {
            vector_0.x - vector_1.x,
                vector_0.y - vector_1.y
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec2 vec2_mul(vec2 vector_0, vec2 vector_1)
    {
        return (vec2) {
            vector_0.x* vector_1.x,
                vector_0.y* vector_1.y
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec2 vec2_div(vec2 vector_0, vec2 vector_1)
    {
        return (vec2) {
            vector_0.x / vector_1.x,
                vector_0.y / vector_1.y
     ...
     */
    DDLS_INLINE f32 vec2_length_squared(vec2 vector)
    {
     ...
     * @return The length.
     */
    DDLS_INLINE f32 vec2_length(vec2 vector)
    {
     ...
     */
    DDLS_INLINE void vec2_normalize(vec2* vector)
    {
     ...
     */
    DDLS_INLINE vec2 vec2_normalized(vec2 vector)
    {
     ...
     * @param vector_0 The first vector.
     * @param vector_1 The second vector.
     * @param tolerance The difference tolerance. Typically DDLS_FLOAT_EPSILON or similar.
     * @return True if within tolerance; otherwise false.
     */
    DDLS_INLINE b8 vec2_compare(vec2 vector_0, vec2 vector_1, f32 tolerance)
    {
     ...
     */
    DDLS_INLINE f32 vec2_distance(vec2 vector_0, vec2 vector_1)
    {
        vec2 d = (vec2){
            vector_0.x - vector_1.x,
            vector_0.y - vector_1.y };
     ...
     */
    DDLS_INLINE vec3 vec3_create(f32 x, f32 y, f32 z)
    {
        return (vec3) { x, y, z };
    }
     ...
     * @return A new vec3
     */
    DDLS_INLINE vec3 vec3_from_vec4(vec4 vector)
    {
     ...
     * @return A new vec4
     */
    DDLS_INLINE vec4 vec3_to_vec4(vec3 vector, f32 w)
    {
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec3 vec3_add(vec3 vector_0, vec3 vector_1)
    {
        return (vec3) {
            vector_0.x + vector_1.x,
                vector_0.y + vector_1.y,
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec3 vec3_sub(vec3 vector_0, vec3 vector_1)
    {
        return (vec3) {
            vector_0.x - vector_1.x,
                vector_0.y - vector_1.y,
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec3 vec3_mul(vec3 vector_0, vec3 vector_1)
    {
        return (vec3) {
            vector_0.x* vector_1.x,
                vector_0.y* vector_1.y,
     ...
     */
    DDLS_INLINE vec3 vec3_mul_scalar(vec3 vector_0, f32 scalar)
    {
        return (vec3) {
            vector_0.x* scalar,
                vector_0.y* scalar,
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec3 vec3_div(vec3 vector_0, vec3 vector_1)
    {
        return (vec3) {
            vector_0.x / vector_1.x,
                vector_0.y / vector_1.y,
     ...
     * @return The squared length.
     */
    DDLS_INLINE f32 vec3_length_squared(vec3 vector)
    {
     ...
     * @return The length.
     */
    DDLS_INLINE f32 vec3_length(vec3 vector)
    {
     ...
     * @param vector A pointer to the vector to be normalized.
     */
    DDLS_INLINE void vec3_normalize(vec3* vector)
    {
     ...
     * @return A normalized copy of the supplied vector
     */
    DDLS_INLINE vec3 vec3_normalized(vec3 vector)
    {
     ...
     */
    DDLS_INLINE f32 vec3_dot(vec3 vector_0, vec3 vector_1)
    {
        f32 p = 0;
     ...
     */
    DDLS_INLINE vec3 vec3_cross(vec3 vector_0, vec3 vector_1)
    {
        return (vec3) {
     ...
     * @return True if within tolerance; otherwise false.
     */
    DDLS_INLINE const b8 vec3_compare(vec3 vector_0, vec3 vector_1, f32 tolerance)
    {
        if (abs(vector_0.x - vector_1.x) > tolerance)
        {
            return false;
     ...
     * @return The distance between vector_0 and vector_1.
     */
    DDLS_INLINE f32 vec3_distance(vec3 vector_0, vec3 vector_1)
    {
        vec3 d = (vec3){
            vector_0.x - vector_1.x,
            vector_0.y - vector_1.y,
     ...
     */
    DDLS_INLINE vec4 vec4_create(f32 x, f32 y, f32 z, f32 w)
    {
        vec4 out_vector;
#if defined(DDLS_USE_SIMD)
     ...
     * @return A new vec3
     */
    DDLS_INLINE vec3 vec4_to_vec3(vec4 vector)
    {
        return (vec3) { vector.x, vector.y, vector.z };
    }
     ...
     * @return A new vec4
     */
    DDLS_INLINE vec4 vec4_from_vec3(vec3 vector, f32 w)
    {
#if defined(DDLS_USE_SIMD)
        vec4 out_vector;
        out_vector.data = _mm_setr_ps(x, y, z, w);
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec4 vec4_add(vec4 vector_0, vec4 vector_1)
    {
        vec4 result;
        for (u64 i = 0; i < 4; ++i)
        {
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec4 vec4_sub(vec4 vector_0, vec4 vector_1)
    {
        vec4 result;
        for (u64 i = 0; i < 4; ++i)
        {
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec4 vec4_mul(vec4 vector_0, vec4 vector_1)
    {
        vec4 result;
        for (u64 i = 0; i < 4; ++i)
        {
     ...
     * @return The resulting vector.
     */
    DDLS_INLINE vec4 vec4_div(vec4 vector_0, vec4 vector_1)
    {
        vec4 result;
        for (u64 i = 0; i < 4; ++i)
        {
     ...
     * @return The squared length.
     */
    DDLS_INLINE f32 vec4_length_squared(vec4 vector)
    {
     ...
     * @return The length.
     */
    DDLS_INLINE f32 vec4_length(vec4 vector)
    {
     ...
     * @param vector A pointer to the vector to be normalized.
     */
    DDLS_INLINE void vec4_normalize(vec4* vector)
    {
     ...
     * @return A normalized copy of the supplied vector
     */
    DDLS_INLINE vec4 vec4_normalized(vec4 vector)
    {
        vec4_normalize(&vector);
        return vector;
    }

    DDLS_INLINE f32 vec4_dot_f32(
     ...
     */
    DDLS_INLINE mat4 mat4_identity()
    {
        mat4 out_matrix;
        zero_memory(out_matrix.data, sizeof(f32) * 16);
     ...
     */
    DDLS_INLINE mat4 mat4_mul(mat4 matrix_0, mat4 matrix_1)
    {
     ...
     */
    DDLS_INLINE mat4 mat4_orthographic(f32 left, f32 right, f32 bottom, f32 top, f32 near_clip, f32 far_clip)
    {
        mat4 out_matrix = mat4_identity();
     ...
     */
    DDLS_INLINE mat4 mat4_perspective(f32 fov_radians, f32 aspect_ratio, f32 near_clip, f32 far_clip)
    {
     ...
     */
    DDLS_INLINE mat4 mat4_look_at(vec3 position, vec3 target, vec3 up)
    {
        mat4 out_matrix;
        vec3 z_axis;
     ...
     */
    DDLS_INLINE mat4 mat4_transposed(mat4 matrix)
    {
        mat4 out_matrix = mat4_identity();
     ...
     */
    DDLS_INLINE mat4 mat4_inverse(mat4 matrix)
    {
    ...
    DDLS_INLINE mat4 mat4_translation(vec3 position)
    {
        mat4 out_matrix = mat4_identity();
     ...
     */
    DDLS_INLINE mat4 mat4_scale(vec3 scale)
    {
        mat4 out_matrix = mat4_identity();
    ...
    DDLS_INLINE mat4 mat4_euler_x(f32 angle_radians)
    {
        mat4 out_matrix = mat4_identity();
    ...
    DDLS_INLINE mat4 mat4_euler_y(f32 angle_radians)
    {
        mat4 out_matrix = mat4_identity();
        f32 c = cos(angle_radians);
        f32 s = sin(angle_radians);
    ...
    DDLS_INLINE mat4 mat4_euler_z(f32 angle_radians)
    {
        mat4 out_matrix = mat4_identity();
    ...
    DDLS_INLINE mat4 mat4_euler_xyz(f32 x_radians, f32 y_radians, f32 z_radians)
    {
     ...
     */
    DDLS_INLINE vec3 mat4_forward(mat4 matrix)
    {
        vec3 forward;
     ...
     * @return A 3-component directional vector.
     */
    DDLS_INLINE vec3 mat4_backward(mat4 matrix)
    {
        vec3 backward;
     ...
     * @return A 3-component directional vector.
     */
    DDLS_INLINE vec3 mat4_up(mat4 matrix)
    {
        vec3 up;
        up.x = matrix.data[1];
        up.y = matrix.data[5];
     ...
     * @return A 3-component directional vector.
     */
    DDLS_INLINE vec3 mat4_down(mat4 matrix)
    {
        vec3 down;
     ...
     * @return A 3-component directional vector.
     */
    DDLS_INLINE vec3 mat4_left(mat4 matrix)
    {
        vec3 left;
     ...
     * @return A 3-component directional vector.
     */
    DDLS_INLINE vec3 mat4_right(mat4 matrix)
    {
        vec3 right;
    ...
    DDLS_INLINE quat quat_identity()
    {
        return (quat) { 0, 0, 0, 1.0f };
    }

    DDLS_INLINE f32 quat_normal(quat q)
    {
        return sqrt(
            q.x * q.x +
            q.y * q.y +
    ...
    DDLS_INLINE quat quat_normalize(quat q)
    {
    ...
    DDLS_INLINE quat quat_conjugate(quat q)
    {
        return (quat) {
            -q.x,
                -q.y,
    ...
    DDLS_INLINE quat quat_inverse(quat q)
    {
        return quat_normalize(quat_conjugate(q));
    }

    DDLS_INLINE quat quat_mul(quat q_0, quat q_1)
    {
        quat out_quaternion;
    ...
    DDLS_INLINE f32 quat_dot(quat q_0, quat q_1)
    {
        return q_0.x * q_1.x +
            q_0.y * q_1.y +
            q_0.z * q_1.z +
    ...
    DDLS_INLINE mat4 quat_to_mat4(quat q)
    {
        mat4 out_matrix = mat4_identity();
    ...
    DDLS_INLINE mat4 quat_to_rotation_matrix(quat q, vec3 center)
    {
        mat4 out_matrix;
    ...
    DDLS_INLINE quat quat_from_axis_angle(vec3 axis, f32 angle, b8 normalize)
    {
    ...
    DDLS_INLINE quat quat_slerp(quat q_0, quat q_1, f32 percentage)
    {
        quat out_quaternion;
     ...
     */
    DDLS_INLINE f32 deg_to_rad(f32 degrees)
    {
        return degrees * DDLS_DEG2RAD_MULTIPLIER;
    }
     ...
     */
    DDLS_INLINE f32 rad_to_deg(f32 radians)
    {
        return radians * DDLS_RAD2DEG_MULTIPLIER;
    }
}